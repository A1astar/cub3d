# 1 "src/parsing/parsing_map.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/parsing/parsing_map.c" 2
# 13 "src/parsing/parsing_map.c"
...
# 14 "src/parsing/parsing_map.c" 2
...
_Bool is_start_position(char c)
{
 if (c == 'N' || c == 'S' || c == 'E' || c == 'W')
  return (1);
 return (0);
...
void try_to_get_player_start_position(t_cub3d *cub3d, char *line, uint64_t y, _Bool *flag)
{
 int i;
