# 1 "src/parsing/parsing.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/parsing/parsing.c" 2
# 13 "src/parsing/parsing.c"
...
# 14 "src/parsing/parsing.c" 2

void parse_elements(t_cub3d *cub3d)
{
 (void)cub3d;
}
# 44 "src/parsing/parsing.c"
...
void check_map_wall(t_cub3d *cub3d, t_map *map)
{
 ...
 while (map->data[i])
 {
  if (i == 0)
   ...
   check_from_last_line(cub3d, map->data[i], map->data[i - 1]);
  else
   check_line(cub3d, map->data[i], map->data[i - 1]);
  i++;
 }
}
