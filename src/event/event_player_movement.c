...
/*   Updated: 2025/05/13 11:22:05 by alacroix         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!can_move_to_north(&cub3d->time, &cub3d->raycast, &cub3d->player,
			&cub3d->map))
		return ;
	cub3d->player.x_pos += cub3d->raycast.x_dir * cub3d->player.velocity
		* cub3d->time.delta_time;
...
{
	if (!can_move_to_east(&cub3d->time, &cub3d->raycast, &cub3d->player,
			&cub3d->map))
		return ;
...
{
	if (!can_move_to_west(&cub3d->time, &cub3d->raycast, &cub3d->player,
			&cub3d->map))
		return ;
	cub3d->player.x_pos += cub3d->raycast.y_dir * cub3d->player.velocity
		* cub3d->time.delta_time;
...
{
	if (!can_move_to_south(&cub3d->time, &cub3d->raycast, &cub3d->player,
			&cub3d->map))
		return ;
	cub3d->player.x_pos -= cub3d->raycast.x_dir * cub3d->player.velocity
		* cub3d->time.delta_time;
