...
/*   Updated: 2025/05/09 19:16:41 by algadea          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_player_north(t_cub3d *cub3d)
{
	if (!can_move_to_north(&cub3d->time, &cub3d->raycast,
		...
		return ;
	// cub3d->player.x_pos += cub3d->raycast.x_dir * cub3d->player.velocity * cub3d->time.delta_time;
	// cub3d->player.y_pos += cub3d->raycast.y_dir * cub3d->player.velocity * cub3d->time.delta_time;
...
void	move_player_east(t_cub3d *cub3d)
{
	if (!can_move_to_east(&cub3d->time, &cub3d->raycast,
				&cub3d->player, &cub3d->map))
		return ;
	// cub3d->player.x_pos -= cub3d->raycast.y_dir * cub3d->player.velocity * cub3d->time.delta_time;
	// cub3d->player.y_pos += cub3d->raycast.x_dir * cub3d->player.velocity * cub3d->time.delta_time;
