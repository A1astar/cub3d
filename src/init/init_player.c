...
/*   Updated: 2025/05/05 18:09:25 by alacroix         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_magic_attributes(t_animation *animation)
{
	animation->frame_count = 13;
	animation->frame_delay = 5;
	animation->active = false;
	animation->state = stand;
}
...
void	init_player(t_player *player, t_minimap *minimap)
{
	...
	init_magic_attributes(&player->magic);
}
