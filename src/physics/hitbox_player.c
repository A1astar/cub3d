...
/*   Updated: 2025/05/13 12:02:06 by alacroix         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	can_move_to_north(t_time *time, t_raycast *raycast, t_player *player,
		t_map *map)
{
	if (map->map[(int)(player->y_pos + raycast->y_dir * player->velocity
			* time->delta_time)][(int)player->x_pos] == '1'
		|| map->map[(int)player->y_pos][(int)(player->x_pos + raycast->x_dir
			* player->velocity * time->delta_time)] == '1')
		return (false);
	else if (map->map[(int)(player->y_pos + raycast->y_dir * player->velocity
			* time->delta_time)][(int)player->x_pos] == 'C'
		|| map->map[(int)player->y_pos][(int)(player->x_pos + raycast->x_dir
...
bool	can_move_to_west(t_time *time, t_raycast *raycast, t_player *player,
		t_map *map)
{
	if (map->map[(int)(player->y_pos - raycast->x_dir * player->velocity
			* time->delta_time)][(int)player->x_pos] == '1'
		|| map->map[(int)player->y_pos][(int)(player->x_pos + raycast->y_dir
			* player->velocity * time->delta_time)] == '1')
		return (false);
	else if (map->map[(int)(player->y_pos - raycast->x_dir * player->velocity
			* time->delta_time)][(int)player->x_pos] == 'C'
		|| map->map[(int)player->y_pos][(int)(player->x_pos + raycast->y_dir
			* player->velocity * time->delta_time)] == 'C')
		return (false);
