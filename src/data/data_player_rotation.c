...
/*   Updated: 2025/05/11 15:52:39 by algadea          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate_player_left(t_cub3d *cub3d, t_time *time)
{
	...
	x_old_dir = cub3d->raycast.x_dir;
	cub3d->raycast.x_dir = cub3d->raycast.x_dir * cos(-SENSIBILITY * time->delta_time)
		- cub3d->raycast.y_dir * sin(-SENSIBILITY * time->delta_time);
	cub3d->raycast.y_dir = x_old_dir * sin(-SENSIBILITY * time->delta_time) + cub3d->raycast.y_dir
		* cos(-SENSIBILITY * time->delta_time);
	x_old_plane = cub3d->raycast.x_plane;
	cub3d->raycast.x_plane = cub3d->raycast.x_plane * cos(-SENSIBILITY * time->delta_time)
		- cub3d->raycast.y_plane * sin(-SENSIBILITY * time->delta_time);
